...
{{--                <tr>
                    ...
                    <td>
                        <select name="conf_pid">
                            ...
                            @foreach($data as $d)
                                <option value="{{$d->conf_id}}">{{$d->conf_name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>--}}
                <tr>
                    ...
                    <td>
                        <input type="text" class="" name="conf_title">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="" name="conf_name">
                ...
                <tr class="field_value">
                    ...
                    <td>
                        ...
                        <p><i class="fa fa-exclamation-circle yellow"></i>格式: 1|开启,0|关闭</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>说明：</th>
                    <td>
                        <textarea type="text" class="" name="conf_tips"></textarea>
                    </td>
                </tr>
                <tr>
                    <th></th>
